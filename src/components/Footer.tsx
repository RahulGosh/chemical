          ...
          >
            <div className="flex items-center space-x-2 mb-4">
              ...
              <div className="flex flex-col">
                <span className="text-white font-bold text-lg leading-tight">Sudarshan</span>
                <span className="text-gray-400 text-xs leading-tight">Pharma Industries</span>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm text-gray-400">info@sudarshanpharma.com</span>
              </div>
            </div>
          </motion.div>
